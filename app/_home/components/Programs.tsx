    ...
    <section id="programs" className={styles.programsSection}>
      <div className={styles.container}>
        <header className={styles.sectionHeader}>
          ...
          <h2>Training <span className={styles.highlight}>Programs</span></h2>
